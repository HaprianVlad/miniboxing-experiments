...
class ArrayOrderBenchmarks extends MyBenchmark {
 ...
 implicit object arrayMonoid extends Monoid[Array[Int]]{
  ...
  trait AdditiveArraySemigroup extends macroSpire.AdditiveSemigroup[Int]{
    
    def plus(x:Array[Int],y:Array[Int]): Array[Int]
...
final case class ZModule[V](vector: Group[V]) extends Module[V, Int] {
 ...
 final  class ArrayVectorSpace[@spec(Int,Float,Long,Double) A: ClassTag: Field]
...
final  class ArrayModule[@spec(Int,Long,Float,Double) A: ClassTag: Ring]
...
final class ArrayEq[@spec(Int,Float,Long,Double) A: Eq]
...
final class ArrayOrder[@spec(Int,Float,Long,Double) A: Order]
...
final class ArrayMonoid[@spec(Int,Float,Long,Double) A: ClassTag]
